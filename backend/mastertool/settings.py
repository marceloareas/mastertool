"""
Django settings for mastertool project.
...
SECRET_KEY = 'django-insecure-cs2t1i&#h_zkf$-#0wmm0rl5l$kv&s7s=9q86-wwzj=r8rfm!$'
...
WSGI_APPLICATION = 'mastertool.wsgi.application'
