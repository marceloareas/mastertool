...
import { MatDialogTitle, MatDialogContent, MatDialogActions, MatDialogClose, MatDialogModule, MAT_DIALOG_DATA} from '@angular/material/dialog';
...
export class StudentProjectModalComponent {
	...
	save(singleProject: any) {
		this.projectService
			.put(this.data.project.id, singleProject)
			.subscribe(() => {
